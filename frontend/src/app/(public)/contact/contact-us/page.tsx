        ...
        <div className="bg-[#FAFBFF] min-h-screen">
            <section className="bg-gradient-to-r from-[#0F2347] to-[#1B3A6B] relative py-20 px-4 overflow-hidden">
                ...
                <div className="max-w-[1280px] mx-auto text-center relative z-10">
                    <h1 className="font-serif text-4xl md:text-5xl font-bold text-white mb-4">
                        Contact <span className="text-[#13A090]">Us</span>
                    </h1>
                    <p className="text-white/70 max-w-2xl mx-auto text-lg pt-2">
                        Get in touch with our Support Centers, Technical Teams, and Administrative Offices.
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 md:py-24 max-w-[1280px] mx-auto px-4 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="flex gap-5 items-start p-6 bg-white border border-[#DDE3F0] rounded-xl shadow-sm hover:border-[#13A090] transition-colors">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-1">
                                        <a href="tel:9585343052" className="block text-[#4A5568] text-sm hover:text-[#E8920A] transition-colors font-medium">
                                            +91 95853 43052
                                        </a>
                                        <a href="tel:8270923781" className="block text-[#4A5568] text-sm hover:text-[#E8920A] transition-colors font-medium">
                                            +91 82709 23781
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-[0_12px_40px_rgba(27,58,107,0.08)] border border-[#DDE3F0]">
                        <h3 className="font-serif text-2xl font-bold text-[#0F2347] mb-2">Send us a Message</h3>
                        <p className="text-[#4A5568] text-sm mb-8">
                            Fill out the form below for affiliation inquiries, verification help, or general questions.
                        </p>
